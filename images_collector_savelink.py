...
# @Author: Yining Qin
# @Loaction: Bay Area
# @Create_Date:   2020-01-29 11:45 AM
# @Last Modified by:   Yining Qin
# @Last Modified time: 2021-02-02 00:00:00
...
if __name__ == "__main__":
    ...
    main_keywords =['solar power','wind power','nuclear','hydro power']
    supplemented_keywords =['low carbon energy']
